...
- [ ] Задача `check_all_subscriptions` — получает все активные подписки
- [ ] Массовая постановка задач на парсинг
- [ ] Настройка интервала проверки (каждые 5-15 минут)
...
- История цен обновляется регулярно
